...
int main(int argc, char** argv){ 
  ...
  #ifdef VECTOR_LOCAL
  double v1[N], v2[N], v3[N];   // TamaÃ±o variable local en tiempo de ejecución ...
  ...
  printf("N: %u Tamaño vector: %lu ", N, N * sizeof(double)); 
